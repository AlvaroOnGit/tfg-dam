/**
 * Contains a script to insert test assets for Elden Ring into the database
 * MUST be executed after the game seed
 */
...
const eldenRingAssets = await readdir(path.join(__dirname, '../../db/data/games/elden_ring'));

const validatedData = [];
const validationErrors = [];

for (const file of eldenRingAssets) {

    const filePath = path.join(__dirname, '../../db/data/games/elden_ring', file);
